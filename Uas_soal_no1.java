...
public class Uas_soal_no1 {
    ...
    public static void main(String[] args) {
        ...
        MahasiswaBaru mahasiswaBaru1 = new MahasiswaBaru("ajisxx", 18, 1237856);
        mahasiswaBaru1.displayInfo();

        // Membuat objek MahasiswaLama
        System.out.println("=======  Mahasiswa Lama =======");
        MahasiswaLama mahasiswaLama1 = new MahasiswaLama("Mahotra", 23, 2017);
